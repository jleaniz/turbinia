...
class JobsManager(manager_interface.ManagerInterface):
  """The jobs manager."""
  ...
  def FilterJobNames(cls, job_names, jobs_denylist=None, jobs_allowlist=None):
    """Filters a list of job names against allow/deny lists.
  ...
  def FilterJobObjects(cls, jobs, jobs_denylist=None, jobs_allowlist=None):
    """Filters a list of job objects against allow/deny lists.
  ...
  def DeregisterJobs(cls, jobs_denylist=None, jobs_allowlist=None):
    """Deregisters a list of job names against allow/deny lists.
